...
\subsection{Rate of Convergence from Data}
    ...
    \begin{figure}[H]
        ...
        \begin{tikzpicture}
            \begin{axis}[
                ...
                \addplot[domain=-6:-4.57, samples=100, color=red]{x - tan(deg(x))};
                \addplot[domain=-4.57:-1.57, samples=100, color=orange]{x - tan(deg(x))};
                \addplot[domain=-1.57:1.57, samples=100, color=green]{x - tan(deg(x))};
                \addplot[domain=1.57:4.57, samples=100, color=blue]{x - tan(deg(x))};
                \addplot[domain=4.57:6, samples=100, color=magenta]{x - tan(deg(x))};

                \addlegendentry{branch 1}
                \addlegendentry{branch 2}
                \addlegendentry{branch 3}
                \addlegendentry{branch 4}
                % \addlegendentry{branch 5}
            \end{axis}
        \end{tikzpicture}
    \end{figure}
\end{example}